...
import a01258927.ApplicationException;
import a01258927.db.Dao;
import a01258927.db.Database;
import a01258927.db.DbConstants;
import a01258927.io.CustomerReader;
...
public class CustomerDao extends Dao {
	 ...
	 * @throws SQLException
	 */
	public ArrayList<Long> getCustomerIds() throws SQLException {
	...
	public enum Column {
		ID("id", 16), //
		FIRST_NAME("firstName", 30), //
		LAST_NAME("lastName", 30), //
		STREET("street", 50), //
		CITY("city", 30), //
